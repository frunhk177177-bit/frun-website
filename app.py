...
# --- 1. 設定網站基礎配置 (必須在第一行) ---
st.set_page_config(page_title="FRUN", page_icon="⚫", layout="centered")

# --- 2. 載入 FRUN 黑白極簡風格 CSS ---
st.markdown("""
    <style>
    /* 強制背景全黑 */
    .stApp {
...
if 'notice' not in st.session_state:
    st.session_state.notice = "⚠️ TYPHOON SIGNAL NO.1 - TRAINING AS USUAL."
